        ...
        <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
          <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
           <div className="flex-1 flex-col justify-start mr-10">
             ...
             <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>New way to make the payment easy,reliable and secure.</p>
           </div>
...
{/* ------Footer bottom--------- */}
            <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] borser-t-[#3F3E45]">
